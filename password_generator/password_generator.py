...
def make_password(length=16, chars = True, lower = True, upper = True, numbers = True):
    ...
    assert length >= 4, 'length must be at least 4 characters'
    assert chars or lower or upper or numbers, 'At least one parameter must be true'
...
if __name__ == '__main__':
    ...
    print('\033[1m\033[94mSEM NÚMEROS\033[0m')
    for i in range(2):
        print(make_password(numbers=False))
    print()
    ...
    print('\033[1m\033[94mAPENAS NÚMEROS\033[0m')
    for i in range(2):
